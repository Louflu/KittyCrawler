...
public partial class MainMenu : Control
{
    ...
    [Signal]
    public delegate void DeckEditorRequestedEventHandler();
    ...
    public override void _Ready()
	{
        ...
        _buttons = new[]
        {
            ...
            GetNode<Button>("MarginContainer/VBoxContainer/DeckEditor"),
            GetNode<Button>("MarginContainer/VBoxContainer/Tutorial"),
    ...
    public void OnDeckEditorPressed()
    {
        EmitSignal(SignalName.DeckEditorRequested);
        GD.Print("Deck editor button pressed");
    }

    public void OnTutorialPressed()
    {
        EmitSignal(SignalName.TutorialRequested);
